...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-10 info-panel shadow-lg rounded p-3" style="background-color: white; margin-top: -90px;">
            <div class="row">
                <div class="col-lg">
                    <img src="img/book.png" alt="mahasiswa" class="float-left mr-3 mb-3">
                ...
                <div class="col-lg">
                    <img src="img/task.png" alt="pertemuan" class="float-left mr-3 mb-3">
                ...
                <div class="col-lg">
                    <img src="img/grafik.png" alt="pertemuan" class="float-left mr-3 mb-3">
